...
public class StadiumGrid {
	...
	public  CountDownLatch latch = new CountDownLatch(10);  //create countdown latch object that counts down from 10 because there are 10 teams
	...
	public void setTeams(int team,boolean b){
		teams[team] = b;
	}

	public boolean getTeams(int team){
		return teams[team];
	}
